...
const Footer = () => {
  return (
    <footer className="bg-curious-blue-500">
      <div className="py-12 px-4 mx-auto max-w-7xl sm:px-6 md:flex md:justify-between md:items-center lg:px-8">
        <div className="text-white lg:order-1">
          ...
          <p className="mt-2 text-sm text-center lg:text-left">
            &copy; Copyright 2022 Investagrams All rights reserved.
          </p>
        </div>
        <div className="flex justify-center mt-8 space-x-5 md:order-2 lg:order-2 lg:mt-0 ">
          <a
            href="#"
            className="p-2 text-gray-400 hover:text-gray-500 rounded-full border-2"
          >
